...
SOAP contracts can be authored in two ways.
...
## 2. Manually author the contract
...
Here is a [SOAP API sample](https://github.com/znsio/petstore-soap-api). Here is the [SOAP contract, api_1.spec](https://github.com/znsio/petstore-contracts/tree/master/in/specmatic/examples/petstore-soap) for which it declares support. You will find the stub examples in api_1_data.

The petstore-soap-api project runs api_1.spec as contract tests.

Here is a [SOAP consumer sample](https://github.com/znsio/petstore-soap-website/). This project contains a simple static page, and JSON API which consumes the SOAP service. It declares the same SOAP API contract as a dependency, and the tests use this contract to stub out the SOAP API that it consumes.
